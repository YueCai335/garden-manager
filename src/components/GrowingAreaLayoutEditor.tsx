      ...
      <div className="layout-editor-grid">
        ...
        <aside className="allocation-controls" aria-label="Plant controls">
          ...
          {isAddFormOpen ? <form className="allocation-form" onSubmit={addAllocation}>
            <h3>Add plant</h3>
            <div className="field"><label htmlFor="allocation-plant-type">Plant type</label><input id="allocation-plant-type" list="plant-type-suggestions" onChange={(event) => setAllocationPlantType(event.target.value)} placeholder="e.g. Tomato" required value={allocationPlantType} /></div>
